...
<!--DWR -->
<script src="/yahoo/dwr/engine.js"></script>
<script src="/yahoo/dwr/util.js"></script>
<script src="/yahoo/dwr/interface/jAppointment.js"></script>
 
</head>
<body class="yui3-skin-sam">
<jsp:include page="/dialog/loginDialog.xhtml"></jsp:include>
<jsp:include page="/dialog/debugDialog.xhtml"></jsp:include>
<jsp:include page="/include/global/head.xhtml"></jsp:include>